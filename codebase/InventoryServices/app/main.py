...
async def lifespan(app: FastAPI):
    ...
    task1 = asyncio.create_task(main.start_consuming_product())
    task2 = asyncio.create_task(main.start_consuming())
    task3 = asyncio.create_task(main.start_consuming_inventory_check())
    try:
        yield
    finally:
